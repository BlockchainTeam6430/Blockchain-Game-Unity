...
namespace Sisus
{
	public abstract class PopupMenuSelectableDrawer<TValue> : PrefixControlComboDrawer<TValue>
	{
		...
		private void OpenMenu()
		{
			...
			Debug.Assert(generatedMenuItems != MemberInfoDrawerUtility.fieldRootItems || generatedMenuItems[1].GetFirstNonGroupChild().IdentifyingObject.GetType() == typeof(System.Reflection.FieldInfo), generatedMenuItems[1].GetFirstNonGroupChild().IdentifyingObject.GetType());
			#endif
